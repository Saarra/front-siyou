...
import { AdsImagesComponent } from './ads-images/ads-images.component';
@Component({
  selector: 'app-ads',
...
public translate: TranslateService,
  ...
  onAddImage(timer){
    ...
    this.formData = this.toFormData(this.form.value);
      ...
      this.advertisementService.addPhotosSuper(this.formData).subscribe(res => {
    ...
    onSelectCashmode(){
      ...
      openImages(){
        let dialogRef = this.dialog.open(AdsImagesComponent)
