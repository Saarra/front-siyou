...
@Component({
  selector: 'app-valid-orders',
  templateUrl: './valid-orders.component.html',
  styleUrls: ['./valid-orders.component.scss'],
  animations: [
...
export class ValidOrdersComponent implements OnInit {
  orderList: any;
