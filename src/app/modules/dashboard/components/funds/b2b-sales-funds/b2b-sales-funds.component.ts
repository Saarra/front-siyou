...
@Component({
  selector: 'app-b2b-sales-funds',
  templateUrl: './b2b-sales-funds.component.html',
  styleUrls: ['./b2b-sales-funds.component.scss'],
  animations: [
...
export class B2bSalesFundsComponent implements OnInit {
  orderList: any;
  ...
  onGetValidOrders(){
    return this.orderService.getValidOrders().subscribe(
      res =>{
        this.orderList = res;
