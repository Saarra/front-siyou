...
@Component({
  selector: 'app-warning-products-s2c',
  templateUrl: './warning-products-s2c.component.html',
  styleUrls: ['./warning-products-s2c.component.scss']
})
export class WarningProductsS2cComponent implements OnInit {
  ...
  onGetProdsS2C(page) {
    return this.productService.getwarningProdsListS2C(this.page).subscribe(
      (res) => {
        this.prods = res;
