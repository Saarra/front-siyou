...
@Component({
  selector: 'app-shop-invalid-orders',
  templateUrl: './shop-invalid-orders.component.html',
  styleUrls: ['./shop-invalid-orders.component.scss'],
  animations: [
...
export class ShopInvalidOrdersComponent implements OnInit {
  orderList: any;
  ...
  onGetInvalidOrders() {
    return this.orderService.getShopInvalidOrders().subscribe(
      res => {
        this.orderList = res;
