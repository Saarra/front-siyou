...
@Component({
  selector: 'app-shop-paid-orders',
  templateUrl: './shop-paid-orders.component.html',
  styleUrls: ['./shop-paid-orders.component.scss'],
  animations: [
...
export class ShopPaidOrdersComponent implements OnInit {
  orderList: any;
  ...
  onGetPaidOrders() {
    return this.orderService.getShopPaidOrders().subscribe(
      res => {
        this.orderList = res;
